...
export default function MidheavenCalculatorClient({ tool }: { tool: ToolLabels }) {
  ...
  const interpretation =
    result && tool.interpretations?.[result.midheaven.sign]
      ? tool.interpretations[result.midheaven.sign]
      : null;
          ...
          <Card className="shadow-2xl border border-white/10 bg-white/5 backdrop-blur-md">
            <CardContent className="p-6 md:p-8">
              ...
              <div className="mt-4 space-y-2 text-sm text-white/90">
                <p>
                  <span className="text-purple-300">{tool.result.sign}:</span> {result.midheaven.sign}{" "}
                  {formatDeg(result.midheaven.degree)}
                </p>
                <p>
                  <span className="text-purple-300">{tool.result.ruler}:</span> {result.midheaven.ruler}
                </p>
                <p>
                  <span className="text-purple-300">{tool.result.ic}:</span> {result.ic.sign}{" "}
                  {formatDeg(result.ic.degree)}
                </p>
                {interpretation && (
                  <p>
                ...
                <p className="text-xs text-white/50 pt-1">{tool.result.disclaimer}</p>
              </div>
